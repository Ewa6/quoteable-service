...
Now that you have all necessary tools on your Mac, go to the [quick start guide](quick-start-guide.html). The quick start guide shows how to clone the repository, install project dependencies, start the JSON server, and make your first call to the Quoteable Service.
